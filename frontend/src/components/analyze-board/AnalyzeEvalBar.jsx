...
const AnalyzeEvalBar = ({ whiteBarHeight, currentEvalValue }) => (
    <div className="app-board-height hidden w-5 bg-[#262421] rounded-sm overflow-hidden flex-col-reverse relative border border-[#3c3a37] shrink-0 shadow-lg md:flex lg:w-8">
